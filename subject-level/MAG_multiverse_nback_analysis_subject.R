# MAG Multiverse — N-Back: Subject-Level Analysis (robustness)
...
#   MAG_multiverse_nback_subject_results.csv
#   MAG_multiverse_nback_subject_conditions_results.csv
#   MAG_multiverse_nback_subject_condition_results.csv
#   MAG_multiverse_nback_subject_interaction_results.csv
#   MAG_multiverse_nback_subject_condition_gaze_results.csv
#
# Note:
...
csv_path <- file.path(csv_dir, "MAG_multiverse_nback_subject.csv")
...
write.csv(M_int, file.path(csv_dir, "MAG_multiverse_nback_subject_results.csv"), row.names = FALSE)
write.csv(M_cond, file.path(csv_dir, "MAG_multiverse_nback_subject_conditions_results.csv"), row.names = FALSE)
message("Saved: MAG_multiverse_nback_subject_results.csv, MAG_multiverse_nback_subject_conditions_results.csv")
...
if (nrow(M_interaction) > 0) {
  write.csv(M_interaction, file.path(csv_dir, "MAG_multiverse_nback_subject_interaction_results.csv"), row.names = FALSE)
  message(sprintf("Saved: MAG_multiverse_nback_subject_interaction_results.csv (%d universes)", nrow(M_interaction)))
} else {
...
if (nrow(M_ca) > 0L) {
  M_ca <- add_sig(M_ca)
  write.csv(M_ca, file.path(csv_dir, "MAG_multiverse_nback_subject_condition_results.csv"), row.names = FALSE)
  message(sprintf("Saved: MAG_multiverse_nback_subject_condition_results.csv (%d universes)", nrow(M_ca)))
} else {
...
if (nrow(M_cg) > 0L) {
  M_cg <- add_sig(M_cg)
  write.csv(M_cg, file.path(csv_dir, "MAG_multiverse_nback_subject_condition_gaze_results.csv"), row.names = FALSE)
  message(sprintf("Saved: MAG_multiverse_nback_subject_condition_gaze_results.csv (%d universes)", nrow(M_cg)))
} else {
...
if ("aperiodic_offset" %in% names(dat) && "aperiodic_exponent" %in% names(dat)) {
  ...
  if (nrow(M_ap_gaze_results) > 0) {
    ...
    write.csv(M_ap_gaze_results, file.path(csv_dir, "MAG_multiverse_nback_subject_aperiodic_gaze_results.csv"), row.names = FALSE)
  ...
  if (nrow(M_ap_cond_results) > 0) {
    ...
    write.csv(M_ap_cond_results, file.path(csv_dir, "MAG_multiverse_nback_subject_aperiodic_condition_results.csv"), row.names = FALSE)
...
if (nrow(robust_main) > 0) write.csv(robust_main, file.path(csv_dir, "MAG_multiverse_nback_subject_results_robustness_summary.csv"), row.names = FALSE)
if (nrow(robust_cond) > 0) write.csv(robust_cond, file.path(csv_dir, "MAG_multiverse_nback_subject_conditions_results_robustness_summary.csv"), row.names = FALSE)
if (nrow(robust_interaction) > 0) write.csv(robust_interaction, file.path(csv_dir, "MAG_multiverse_nback_subject_interaction_results_robustness_summary.csv"), row.names = FALSE)
if (nrow(robust_ca) > 0) write.csv(robust_ca, file.path(csv_dir, "MAG_multiverse_nback_subject_condition_results_robustness_summary.csv"), row.names = FALSE)
if (nrow(robust_cg) > 0) write.csv(robust_cg, file.path(csv_dir, "MAG_multiverse_nback_subject_condition_gaze_results_robustness_summary.csv"), row.names = FALSE)
if (nrow(robust_ap_gaze) > 0) write.csv(robust_ap_gaze, file.path(csv_dir, "MAG_multiverse_nback_subject_aperiodic_gaze_results_robustness_summary.csv"), row.names = FALSE)
if (nrow(robust_ap_cond) > 0) write.csv(robust_ap_cond, file.path(csv_dir, "MAG_multiverse_nback_subject_aperiodic_condition_results_robustness_summary.csv"), row.names = FALSE)
...
if (nrow(robustness_summary) > 0) {
  write.csv(robustness_summary, file.path(csv_dir, "MAG_multiverse_nback_subject_robustness_summary.csv"), row.names = FALSE)
